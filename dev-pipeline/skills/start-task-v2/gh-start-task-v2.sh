#!/usr/bin/env bash
# gh-start-task-v2 — zero-confirmation bootstrap: GitHub issue → feature branch + context file
# Usage:
#   gh-start-task-v2 <issue-number>
#   gh-start-task-v2 <issue-number> <branch-type>
#   gh-start-task-v2 <issue-number> <branch-type> <slug>
#
# Examples:
#   gh-start-task-v2 42
#   gh-start-task-v2 42 feat
#   gh-start-task-v2 42 fix payment-null-pointer

set -euo pipefail

ISSUE_NUM="${1:?Usage: gh-start-task-v2 <issue-number> [type] [slug]}"
TYPE="${2:-feat}"
SLUG="${3:-}"
