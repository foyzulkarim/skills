...
Give a final recap ("I'll write up the requirements now. Quick recap: [3–5 sentences]. Anything missing?"), then save to `/specs/requirements/REQ-<slug>.md` using the format below.
